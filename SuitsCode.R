...
SuitsS2S6Rating <- as.data.frame(as.double(cbind(S2EP1, S2EP2, S2EP3, S2EP4, S2EP5, S2EP6, S2EP7, S2EP8, S2EP9, S2EP10, S2EP11, S2EP12, S2EP13, S2EP14, S2EP15, S2EP16,
...
colnames(SuitsS2S6Rating)
names(SuitsS2S6Rating)[1] <- "AllSuitsRatings"

##### Combining Code ######
SuitsFull <- rbind(SuitsS2, SuitsS3, SuitsS4, SuitsS5, SuitsS6)
SuitsFull <- cbind(SuitsFull, SuitsS2S6Rating)
